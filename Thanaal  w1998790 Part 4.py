...
while run:
    ...
    if Value == "Progress":
        ...
        output[uow_number] = "Progress",pass_credits,defer_credits,fail_credits
        dict_outcome.update(output)
        progress_count += 1
        stu.write("\n%s" % credit_list)
        ...
        list.append(credit_list)
        output[uow_number] = "Progress (module trailer)",pass_credits,defer_credits,fail_credits
        dict_outcome.update(output)
        trailer_count += 1
        stu.write("\n%s" % credit_list)
        ...
        list.append(credit_list)
        output[uow_number] = "Exclude",pass_credits,defer_credits,fail_credits
        dict_outcome.update(output)
        excluded_count += 1
        stu.write("\n%s" % credit_list)
    else:
        ...
        list.append(credit_list)
        output[uow_number] = "Module retriever",pass_credits,defer_credits,fail_credits
        dict_outcome.update(output)
        retriever_count += 1
        stu.write("\n%s" % credit_list)
